...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.highlight'
        db.add_column(u'djangocms_events_event', 'highlight',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.highlight'
        db.delete_column(u'djangocms_events_event', 'highlight')
    ...
    models = {
        ...
        u'djangocms_events.eventslist': {
            ...
            'render_mode': ('django.db.models.fields.CharField', [], {'default': "'list.html'", 'max_length': '255'}),
