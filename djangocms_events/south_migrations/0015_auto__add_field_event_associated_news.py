...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.associated_news'
        db.add_column(u'djangocms_events_event', 'associated_news',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djangocms_news.NewsItem'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.associated_news'
        db.delete_column(u'djangocms_events_event', 'associated_news_id')
    ...
    models = {
        ...
        u'djangocms_events.event': {
            ...
            'associated_news': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djangocms_news.NewsItem']", 'null': 'True', 'blank': 'True'}),
        ...
        u'djangocms_events.eventslist': {
            ...
            'event_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
            'max_item_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'render_mode': ('django.db.models.fields.CharField', [], {'default': "('list.html', u'List')", 'max_length': '255'}),
        ...
        u'djangocms_news.newsitem': {
            ...
            'additional_images_pagination': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'additional_images_speed': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3000'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'youtube_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'sites.site': {
