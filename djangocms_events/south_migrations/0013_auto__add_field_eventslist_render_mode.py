...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsList.render_mode'
        db.add_column(u'djangocms_events_eventslist', 'render_mode',
                      self.gf('django.db.models.fields.CharField')(default=('list.html', u'List'), max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsList.render_mode'
        db.delete_column(u'djangocms_events_eventslist', 'render_mode')
