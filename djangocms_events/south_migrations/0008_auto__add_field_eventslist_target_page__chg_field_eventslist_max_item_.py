...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(m2m_table_name, ['event_id', 'page_id'])

        # Adding field 'EventsList.target_page'
        db.add_column(u'djangocms_events_eventslist', 'target_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'EventsList.max_item_count'
        db.alter_column(u'djangocms_events_eventslist', 'max_item_count', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventsList.target_page'
        db.delete_column(u'djangocms_events_eventslist', 'target_page_id')


        # Changing field 'EventsList.max_item_count'
        db.alter_column(u'djangocms_events_eventslist', 'max_item_count', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'djangocms_events.eventslist': {
            ...
            'target_page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
