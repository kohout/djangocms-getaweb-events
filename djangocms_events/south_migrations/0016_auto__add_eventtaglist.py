...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventTagList'
        db.create_table(u'djangocms_events_eventtaglist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'djangocms_events', ['EventTagList'])


    def backwards(self, orm):
        # Deleting model 'EventTagList'
        db.delete_table(u'djangocms_events_eventtaglist')
    ...
    models = {
        ...
        u'djangocms_events.eventtaglist': {
            'Meta': {'object_name': 'EventTagList', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
