...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.cms_link'
        db.add_column(u'djangocms_events_event', 'cms_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.external_link'
        db.add_column(u'djangocms_events_event', 'external_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.link_title'
        db.add_column(u'djangocms_events_event', 'link_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.cms_link'
        db.delete_column(u'djangocms_events_event', 'cms_link_id')

        # Deleting field 'Event.external_link'
        db.delete_column(u'djangocms_events_event', 'external_link')

        # Deleting field 'Event.link_title'
        db.delete_column(u'djangocms_events_event', 'link_title')
