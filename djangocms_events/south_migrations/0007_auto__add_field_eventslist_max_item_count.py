...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsList.max_item_count'
        db.add_column(u'djangocms_events_eventslist', 'max_item_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsList.max_item_count'
        db.delete_column(u'djangocms_events_eventslist', 'max_item_count')
    ...
    models = {
        ...
        u'djangocms_events.eventslist': {
            ...
            'max_item_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
