...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsList.archive'
        db.add_column(u'djangocms_events_eventslist', 'archive',
                      self.gf('django.db.models.fields.CharField')(default=('all', u'All Events'), max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsList.archive'
        db.delete_column(u'djangocms_events_eventslist', 'archive')
