...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsList.event_list'
        db.add_column(u'djangocms_events_eventslist', 'event_list',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsList.event_list'
        db.delete_column(u'djangocms_events_eventslist', 'event_list_id')
